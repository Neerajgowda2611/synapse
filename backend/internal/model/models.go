...
const (
	JobTargetKindJob           JobTargetKind = "job"
	JobTargetKindCareerProfile JobTargetKind = "career_profile"
	JobTargetKindProject       JobTargetKind = "project"
)
...
type Job struct {
	...
	TargetKind     JobTargetKind `gorm:"type:text;not null;default:job;index" json:"target_kind"`
