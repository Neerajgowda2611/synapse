...
function buildSearchItems(items: readonly NavGroup[]): SearchItem[] {
...
export function SearchDialog({
  ...
  const recommendations = searchItems.filter((item) => !item.disabled)
  ...
  const renderGroups = (list: SearchItem[]) =>
    groupBy(list).map(({ group, items: groupItems }, index) => (
